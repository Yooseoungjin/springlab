...
<%--&lt;%&ndash;    <jsp:include page="../include/index.jsp"></jsp:include>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;<jsp:include page="../include/navbar.jsp">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <jsp:param value="message" name="thisPage" />&ndash;%&gt;--%>
